...
iptables --insert $IPCHAIN -p udp --dport 53 -m u32 --u32 "0x26=0x00010962 && 0x28=0x09626974 && 0x2c=0x73747265 && 0x30=0x73730363 && 0x34=0x6f6d0000 && 0x37=0x00ff0001" -j $TARGET -m comment --comment "DROP DNS Q ANY bitstress.com"